...
/* System Settings */
    ...
    sendtoJail_locations[] = { "Cop_Spawn_Sea_1","cop_spawn_HQ_1","cop_spawn_east_1","cop_spawn_airHQ_1","cop_spawn_North_1" }; //Enter the variableName from the mission.sqm here to allow cops to send a person to jail at these locations.
    jail_forceWalk = true;
